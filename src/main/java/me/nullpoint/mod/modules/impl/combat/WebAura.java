...
public class WebAura extends Module {
    ...
    private boolean placeWeb(BlockPos pos) {
        ...
        if (checkMine.getValue() && (Nullpoint.BREAK.isMining(pos) || !noMine.getValue() && pos.equals(PacketMine.breakPos))) return false;
        if (BlockUtil.getPlaceSide(pos, placeRange.getValue()) != null && mc.world.isAir(pos)) {
            ...
            if (noMine.getValue() && pos.equals(PacketMine.breakPos)) {
